...
do
    ...
    BACKBONE=iresnet50
    POOLING=E
    python train_teacher.py --seed 5 --gpus 0 --data_dir /home/jovyan/SSDb/sung/dataset/face_dset/ --save_dir checkpoint/teacher/$BACKBONE-$POOLING-IR-$MARGIN/ \
...
do
    ...
    do
        ...
        python train_teacher.py --seed 5 --gpus 1 --data_dir /home/jovyan/SSDb/sung/dataset/face_dset/ --save_dir checkpoint/naive/$BACKBONE-$POOLING-IR-$MARGIN/resol$RESOLUTION-$INTERPOLATION \
