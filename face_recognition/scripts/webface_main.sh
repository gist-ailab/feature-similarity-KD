...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nnodes=1 --nproc_per_node=4 --master_port=411 train_student_multi.py --seed $SEED --data_dir $DATA_DIR --down_size $RESOLUTION \
