...
do
    ...
    do
        ...
        RESOLUTION=0
        CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --master_port=321 python train_teacher_multi.py \
        ...
        python train_embed.py --gpus 0 --dataset $DATASET --data_dir $DATA_DIR --mode ir --seed $SEED --teacher_path $TEACHER
        ...
        CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --master_port=341 train_student_multi.py --seed $SEED --data_dir $DATA_DIR --down_size $RESOLUTION \
