...
class FaceDataset(data.Dataset):
    def __init__(self, root, data_type, file_list, down_size, transform=None, loader=img_loader, flip=True, equal=True, teacher_folder='', cross_sampling=False, margin=0.0):
        self.root = root
