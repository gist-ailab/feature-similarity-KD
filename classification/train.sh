...
# Naive
CUDA_VISIBLE_DEVICES=0 python train_teacher.py --resolution 1 --lr 0.1 --arch vgg8 --save-dir naive_epoch200_lr{0.1}_resol1
CUDA_VISIBLE_DEVICES=3 python train_teacher.py --resolution 8 --lr 0.1 --arch vgg8 --save-dir naive_epoch200_lr{0.1}_resol8
